            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full relative">
                ...
                <div className="text mt-4 border rounded border-purple-500 p-6">
                  <ol>
                    <li>
                      1. Attach the motor cables into the wire adaptor board.
                    </li>
                    <li>
                      2. Attach the ¾" 4-40 screw in the front using the
                      flathead screwdriver. The 4-40 screw will go through the
                      motor stand into the small hole on the motor housing.
                    </li>
                  </ol>
                </div>
                <a
