              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full relative">
                ...
                <div className="text-center w-full mt-4">
                  <img
                    ...
                    src={require("../../assets/images/9 100.png")}
                    alt=""
                  />
                </div>
                <div className="text mt-4 border rounded border-purple-500 p-6">
                  <ol>
                    <li>
                      1. Insert the motors into the motor housing with the cable
                      slipped through the gap in the housing.{" "}
                    </li>
                    <li>
                      2. Fix each motor to the motor housing using a screwdiver.
                    </li>
                  </ol>
                </div>
                <a
