              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full relative">
                ...
                <div className="text-center w-full mt-4">
                  <img
                    ...
                    src={require("../../assets/images/1 235.png")}
                    alt=""
                  />
                </div>
                <div className="text mt-4 border rounded border-purple-500 p-6">
                  <ol>
                    ...
                    <li>
                      2. Install the second L2 arm linkage with a Teflon washer
                      sandwiched between the L1 and L2 arm linkages.
                    </li>
                    <li>
                      3. Place the end-effector cap into the top L2 arm linkage,
                      sandwich the end-effector handle washer between the two L2
                      arm linkages and finally screw in the end-effector screw
                      to complete this section (as pictured).
                    </li>
                  </ol>
                </div>
                <a
