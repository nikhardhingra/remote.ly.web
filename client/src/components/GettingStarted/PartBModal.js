            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full relative">
                ...
                <div className="text mt-4 border rounded border-purple-500 p-6">
                  <ol>
                    <li>
                      1. Insert the 4-40 set screws part way into both of the L1
                      arm linkages.
                    </li>
                    <li>
                      2. Once the motor shafts and the set screws are aligned,
                      attach the arm linkages. Move the arms around to ensure
